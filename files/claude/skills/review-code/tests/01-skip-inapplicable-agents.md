...
- `docs/api-reference.md` — Updated 3 endpoint descriptions to match the new response schema
- `docs/getting-started.md` — Added a new "Authentication" section
- `README.md` — Updated the architecture diagram description

No source files changed. No tests changed. No configuration changed. This is a documentation-only PR.

The developer says: "Can you review this? It's a docs update but I want a comprehensive review."
