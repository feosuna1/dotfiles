...
description: >-
  ...
  session — "write a handoff prompt", "I'm running low on context", "continue
  this in a fresh session". This is for bootstrapping a *new agent session*, not
  for summarizing the conversation for the user themselves and not for commit/PR
  messages.
---
